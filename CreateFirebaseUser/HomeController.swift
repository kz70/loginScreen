...
class HomeController: UIViewController {
    ...
    //mark hleper function
    
    func configureViewComponents() {
        view.backgroundColor = UIColor.hotPink()
        
        navigationItem.title = "Supergirls Code"
        ...
        navigationItem.leftBarButtonItem?.tintColor = .white
            ...
            navigationController?.navigationBar.barTintColor = UIColor.hotPink()
